...
/**
 * Collects metadata for creating a {@link org.springframework.util.backoff.BackOff}.
 * Values can be provided as is or using a {@code *String} equivalent that supports
 * more format, as well as expression evaluations.
 * <p>
 * The available fields leads to the following:
 * <ul>
 ...
 * <li>In all other cases, an {@link ExponentialBackOff} is used with the values of
 * {@link #maxDelay()}, {@link #multiplier()} and {@link #jitter()} or their respective
 * defaults if not set.</li>
 * </ul>
 *
 * @author Dave Syer
 * @author Gary Russell
